from MainFolder.Activity1Class import Sentiment_Analysis
from MainFolder.Activity2Class import NER_training_model
from MainFolder.Activity3Class import Translation_APIS
